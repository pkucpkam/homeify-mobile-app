...
public class ContractDetailsActivity extends AppCompatActivity {
    ...
    private void setupMenuListeners() {
        ...
        ivChat.setOnClickListener(v -> {
            Intent intent = new Intent(ContractDetailsActivity.this, ChatListActivity.class);
        ...
        ivLogo.setOnClickListener(v -> {
            Intent intent = new Intent(ContractDetailsActivity.this, MainActivity.class);
            startActivity(intent);
        });

        ImageView ivPostRoom = findViewById(R.id.ivPostRoom);
        ivPostRoom.setOnClickListener(v -> {
            Intent intent = new Intent(ContractDetailsActivity.this, PostingRoom.class);
            startActivity(intent);
        });
